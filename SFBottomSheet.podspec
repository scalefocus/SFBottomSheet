#
#  Be sure to run `pod spec lint SFBottomSheet.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.homepage     = "https://github.com/scalefocus/SFBottomSheet"
  ...
  spec.source       = { :git => "https://github.com/scalefocus/SFBottomSheet.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "SFBottomSheet", "SFBottomSheet/SFBottomSheet/**/*.{h,m,swift,xib}"
